...
import { UAEFTSStep as UAEFTSStepComponent } from "@/components/steps/UAEFTSStep";

export const UAEFTSStep = () => {
  ...
  const extendedSteps = [
    ...
    { id: 4, name: "UAEFTS", description: "Mandate for recurring payments", active: true },
    { id: 5, name: "Agreement Signing", description: "Digital signing of agreement", active: false }
  ];

  const handleNext = () => {
    navigate("/loan-application/agreement-signing");
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <ProgressIndicator steps={extendedSteps} currentStep={4} />
        <div className="mt-8">
          <UAEFTSStepComponent onNext={handleNext} onPrev={handlePrev} />
        </div>
      </div>
      <PageFooter />
    </div>
