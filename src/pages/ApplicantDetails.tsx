              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div>
                    ...
                    <Input id="companyNumber" value={formData.companyNumber} onChange={e => handleInputChange('companyNumber', e.target.value)} />
                  </div>
                  <div>
                    <Label htmlFor="taxRegistration">Tax Registration Number*</Label>
                    <Input id="taxRegistration" value={formData.taxRegistration} onChange={e => handleInputChange('taxRegistration', e.target.value)} />
                  </div>
                </div>

                {/* Verify button - only show if not verified */}
                {!isVerified && <div className="mb-6">
                ...
                {isVerified && <>
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <Input id="registeredName" value={formData.registeredName} onChange={e => handleInputChange('registeredName', e.target.value)} className="bg-green-50 border-green-200" readOnly />
                      ...
                      <div>
                        ...
                        <Input id="licensingAuthority" value={formData.licensingAuthority} onChange={e => handleInputChange('licensingAuthority', e.target.value)} className="bg-green-50 border-green-200" readOnly />
                        <div className="flex items-center mt-1">
                          <Check className="w-4 h-4 text-green-600 mr-1" />
                          <span className="text-xs text-green-600">Verified</span>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div>
                        ...
                        <Input id="companyName" value={formData.companyName} onChange={e => handleInputChange('companyName', e.target.value)} className="bg-green-50 border-green-200" readOnly />
                        <div className="flex items-center mt-1">
                          <Check className="w-4 h-4 text-green-600 mr-1" />
                          <span className="text-xs text-green-600">Verified</span>
                        </div>
                      ...
                      <div>
                        ...
                        <Input id="legalForm" value={formData.legalForm} onChange={e => handleInputChange('legalForm', e.target.value)} className="bg-green-50 border-green-200" readOnly />
                        <div className="flex items-center mt-1">
                          <Check className="w-4 h-4 text-green-600 mr-1" />
                          <span className="text-xs text-green-600">Verified</span>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <Input id="addressLine1" value={formData.addressLine1} onChange={e => handleInputChange('addressLine1', e.target.value)} className="bg-green-50 border-green-200" readOnly />
                        <div className="flex items-center mt-1">
                          <Check className="w-4 h-4 text-green-600 mr-1" />
                          <span className="text-xs text-green-600">Verified</span>
                        </div>
                      ...
                      <div>
                        ...
                        <Input id="street" value={formData.street} onChange={e => handleInputChange('street', e.target.value)} className="bg-green-50 border-green-200" readOnly />
                        <div className="flex items-center mt-1">
                          <Check className="w-4 h-4 text-green-600 mr-1" />
                          <span className="text-xs text-green-600">Verified</span>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <Input id="poBox" value={formData.poBox} onChange={e => handleInputChange('poBox', e.target.value)} className="bg-green-50 border-green-200" readOnly />
                        <div className="flex items-center mt-1">
                          <Check className="w-4 h-4 text-green-600 mr-1" />
                          <span className="text-xs text-green-600">Verified</span>
                        </div>
                      ...
                      <div>
                        ...
                        <Input id="area" value={formData.area} onChange={e => handleInputChange('area', e.target.value)} className="bg-green-50 border-green-200" readOnly />
                        <div className="flex items-center mt-1">
                          <Check className="w-4 h-4 text-green-600 mr-1" />
                          <span className="text-xs text-green-600">Verified</span>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div>
                        ...
                        <select id="town" value={formData.town} onChange={e => handleInputChange('town', e.target.value)} className="flex h-10 w-full rounded-md border border-green-200 bg-green-50 px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" disabled>
